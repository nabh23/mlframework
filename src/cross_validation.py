...
-- holdout : time series ; millions of samples
"""
...
class CrossValidation:
    ...
    def split(self):
        ...
        """
        if self.problem_type in ["binary classification", "multiclass_classification"]:
            ...
            self.dataframe.loc[len(self.dataframe) -  num_holdout_samples:, "kfold"] = 1.  #holdout
